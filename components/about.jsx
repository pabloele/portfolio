    ...
    >
      <div className="max-w-[1240px] m-auto md:flex md:gap-8">
        ...
        <div className="md:w-2/3 text-center md:text-justify px-5">
          <h1 className={bruno_ace.className}>{" <About/>"}</h1>
          {/* <h2>Quién soy</h2> */}
          ...
          <div className={montserrat.className}>
            <p className="py-5 text-xl font-semibold">
              ...
              estoy enfocado en construir aplicaciones responsivas que resuelvan
              problemas reales. Me apasiona integrar nuevas tecnologías a mis
              proyectos (you´ll break it until you make it 😊). En esta página
              podrás navegar por algunos de mis trabajos. ¿Te gusta lo que ves?
